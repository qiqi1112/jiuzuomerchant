            ...
            <div class="head-handle clearfix">
                ...
                <el-dialog :visible.sync="dialogVisible" @close="handleCancel">
                    ...
                    <el-tabs v-else v-model="activeName" @tab-click="handleClick">
                        ...
                        <el-tab-pane label="威士忌" name="drinks2">
                            <span class="add-classify-title goods-info">商品信息</span>
                            <drinks-tab
                                v-if="activeName == 'drinks2'"
                                :drinksFormParent="drinksForm"
                                @drinksFormChild="getChildDrinksForm"
                            ></drinks-tab>
                        </el-tab-pane>

                        <el-tab-pane label="白兰地" name="drinks3">
                            <span class="add-classify-title goods-info">商品信息</span>
                            <drinks-tab
                                v-if="activeName == 'drinks3'"
                                :drinksFormParent="drinksForm"
                                @drinksFormChild="getChildDrinksForm"
                            ></drinks-tab>
                        </el-tab-pane>

                        <el-tab-pane label="伏特加" name="drinks4">
                            <span class="add-classify-title goods-info">商品信息</span>
                            <drinks-tab
                                v-if="activeName == 'drinks4'"
                                :drinksFormParent="drinksForm"
                                @drinksFormChild="getChildDrinksForm"
                            ></drinks-tab>
                        </el-tab-pane>

                        <el-tab-pane label="香槟" name="drinks5">
                            <span class="add-classify-title goods-info">商品信息</span>
                            <drinks-tab
                                v-if="activeName == 'drinks5'"
                                :drinksFormParent="drinksForm"
                                @drinksFormChild="getChildDrinksForm"
                            ></drinks-tab>
                        </el-tab-pane>

                        <el-tab-pane label="红酒" name="drinks6">
                            <span class="add-classify-title goods-info">商品信息</span>
                            <drinks-tab
                                v-if="activeName == 'drinks6'"
                                :drinksFormParent="drinksForm"
                                @drinksFormChild="getChildDrinksForm"
                            ></drinks-tab>
                        </el-tab-pane>

                        <el-tab-pane label="啤酒" name="drinks7">
                            <span class="add-classify-title goods-info">商品信息</span>
                            <drinks-tab
                                v-if="activeName == 'drinks7'"
                                :drinksFormParent="drinksForm"
                                @drinksFormChild="getChildDrinksForm"
                            ></drinks-tab>
                        </el-tab-pane>

                        <el-tab-pane label="鸡尾酒" name="drinks8">
                            <span class="add-classify-title goods-info">商品信息</span>
                            <drinks-tab
                                v-if="activeName == 'drinks8'"
                                :drinksFormParent="drinksForm"
                                @drinksFormChild="getChildDrinksForm"
                            ></drinks-tab>
                        </el-tab-pane>
...
export default {
    ...
    methods: {
        ...
        handleClick(tab, event) {
            ...
            console.log('pppp', this.activeNum, this.activeName);
            this.clearAllForm();
        },
