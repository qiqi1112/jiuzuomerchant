            ...
            <div class="position">
                <div class="crumbs">
                    <el-breadcrumb separator="/">
                        <el-breadcrumb-item> <i class="el-icon-lx-cascades"></i> 排号管理 </el-breadcrumb-item>
                    </el-breadcrumb>
                </div>

                <div class="tit_top">
                    <span class="li_text"
                        >今日排号总数<span>{{ todayData.todayTotalLy }}</span></span
                    >
                    <span class="li_text"
                        >今日成功排号数<span>{{ todayData.totalSuccessLy }}</span></span
                    >
                    <span class="li_text"
                        >今日当前排号总数<span>{{ todayData.nowTotalLy }}</span></span
                    >
                    <span class="li_text"
                        >今日取消排号数<span>{{ todayData.todayCancelTotalLy }}</span></span
                    >
                    <br />
                    <span class="li_text"
                        >今日当前抢座总数<span>{{ todayData.nowTotalVie }}</span></span
                    >
                    <span class="li_text"
                        >今日成功抢座数<span>{{ todayData.todaySuccessTotalVie }}</span></span
                    >
                    <span class="li_text"
                        >今日抢座总数<span>{{ todayData.todayTotalVie }}</span></span
                    >
                </div>
                ...
                <div class="fl_box">
                    ...
                    <ul class="scl_box">
                        <li class="li_n now_num" v-for="(item, index) in robList" :key="index">
                            ...
                            <div class="now_r">
                                ...
                                <div>
                                    取号时间 <span class="tl">{{ item.createTime }}</span>
                                </div>
                                <div>
                                    等待时常 <span class="tl"> {{ item.createTime | timeFormat }}</span>
                                </div>
                    ...
                    <ul class="scl_box">
                        <li class="li_n now_num" v-for="(item, index) in rowList" :key="index">
                            ...
                            <div class="now_r">
                                <div>
                                    当前位于第<span class="num"> {{ index + 1 }} </span>位 （{{ item.codeNo }}）
                                </div>
                                <div>
                                    取号时间 <span class="tl">{{ item.createTime }}</span>
                                </div>
...
#numeral {
    ...
    .numeral_list {
        ...
        .succ_canc_box::-webkit-scrollbar {
            display: none;
        }
        .scl_box::-webkit-scrollbar {
            display: none;
        }
    }
}
